...
export const getBookArtifactEndpoint: Endpoint<{
  params: { id: string; editionId: string };
  returnType: BookArtifact | null;
}> = {
...
export const generateBookArtifactEndpoint: Endpoint<{
  params: { id: string; editionId: string };
  returnType: BookArtifact;
}> = {
  url: "/books/:id/editions/:editionId/artifacts",
  methodType: MethodType.POST,
};

export const downloadBookArtifactPdfEndpoint: Endpoint<{
  params: { id: string; editionId: string };
  returnType: Blob;
}> = {
